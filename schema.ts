...
// Donations Table — tracks the real lifecycle of every M-Pesa contribution attempt,
// from the moment an STK push is sent through to Safaricom's final confirmation.
// Nothing in the UI should ever claim a payment succeeded unless a row here says so.
